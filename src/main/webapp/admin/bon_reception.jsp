...
<title>Admin:Bon Reception</title>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-4 offset-md-4">
					<div class="card">
						<div class="card-body ">
						<h4 class="text-center">Bon Reception</h4>
						<c:if test="${not empty SuccMsg }">
							...
							<form action="../bon_reception" method="post" enctype="multipart/form-data">
							  <div class="mb-3">
   								 <label for="text" class="form-label"> Code Bon</label>
							 ...
							 <div class="md-3">
							  ...
							  <br>
							  <label for="inputState">Date Bon</label> 
							  <br>
							  <div class="input-group date md-3" data-provide="datepicker">
  								<input type="date" class="form-control" name="fdatebon">
								    <div class="input-group-addon">
								        <span class="glyphicon glyphicon-th"></span>
								    </div>
								</div>
								<br>
								<label for="inputState">Date Reception</label> 
								<div class="input-group date md-3" data-provide="datepicker">
  								<input type="date" class="form-control" name="fdaterec">
								    <div class="input-group-addon">
								        <span class="glyphicon glyphicon-th"></span>
								    </div>
								</div>
