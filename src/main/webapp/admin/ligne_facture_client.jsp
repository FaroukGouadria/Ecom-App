		...
		<div class="container">
			<div class="row">
				<div class="col-md-4 offset-md-4">
					<div class="card">
						<div class="card-body ">
						<h4 class="text-center">Add Ligne Facture Client</h4>
						<c:if test="${not empty SuccMsg }">
							...
							<form action="../ligne_facture_client" method="post" >
							<div class="mb-3">
   								 <label for="text" class="form-label"> code Ligne</label>
   										 <input type="text" class="form-control"
   										  name="fcodeligne" id="exampleInputEmail1"  placeholder="code" required="required">
							</div>
							 <br>
							  <div class="md-3">
							    <label for="inputState">Code Facture</label> 
							    <br>
							    <select
							    id="inputState" name="fcodefacture" class="form-control text-center" onchange="showState(this.value)">
